...
@section('title', 'SIMTEK | Laporan Alat Kesehatan')

@section('content')

<h1 class="mt-4">Laporan Data Alat Kesehatan</h1>
<ol class="breadcrumb mb-4">
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
    <li class="breadcrumb-item active">Laporan Data Alat Kesehatan</li>
</ol>
...
<div class="card mb-4">
    <div class="card-header">
        ...
        <a href="{{ route('viewexportsmedicinedevice.download') }}" class="btn btn-danger float-end me-2">
            <i class="fas fa-file-pdf me-1"></i> Export PDF
        </a>
        <a href="{{ route('viewexportsmedicinedevice.view') }}" target="_blank" class="btn btn-info float-end me-2">
